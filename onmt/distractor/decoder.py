...
from onmt.distractor.attention import HierarchicalAttention, HierarchicalAttentionAns
...
class HierDecoderAns(nn.Module):
    """
    Hierarchal Decoder for sent and word level
    Args:
        Unfinished!!! focus on encoder first~
    ...
    def __init__(self, rnn_type,
                 ...
                 attn_type="general",
                 dropout=0.0, embeddings=None):
        super(HierDecoderAns, self).__init__()
        ...
        self.attn = HierarchicalAttentionAns(hidden_size, attn_type=attn_type)
